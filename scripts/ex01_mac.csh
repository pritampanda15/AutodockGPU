#!/bin/csh
#
# $Id: ex01_mac.csh,v 1.2 2007/08/06 16:30:26 rhuey Exp $
#
...
ln -s $VSTROOT/split_multi_mol2_file.py .
ln -s $VSTROOT/zinc.mol2 .
pythonsh split_multi_mol2_file.py -i zinc.mol2
\rm zinc.mol2
\rm split_multi_mol2_file.py 
