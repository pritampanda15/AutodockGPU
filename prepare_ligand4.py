...
# 
#
# $Header: /opt/cvs/VSTutorial/prepare_ligand4.py,v 1.2 2007/01/30 01:05:46 rhuey Exp $
#
import os 
...
if __name__ == '__main__':
    ...
    try:
        opt_list, args = getopt.getopt(sys.argv[1:], 'l:vo:d:A:Cp:U:B:R:MFI:Zh')
